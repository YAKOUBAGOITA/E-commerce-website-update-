...
<table class="table table-bordered mt-5">
    ...
    <tbody class="bg-secondary  text-light">
        ...
        <tr class="text-center">
            ...
            <td><a href='index.php?edit_brands=<?php echo $brand_id ?>' class='btn btn-primary text-light text-light'>
            <i class='fa-solid fa-pen-to-square'></i></a></td>

            <td><a href='index.php?delete_brands=<?php echo $brand_id ?>' 
            type="button" class="btn btn-primary text-light" data-toggle="modal" data-target="#exampleModal">
