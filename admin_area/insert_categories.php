<?php 
 ...
 if(isset($_POST['insert_cat'])){
   ...
   if($number>0){
      echo"<script>alert('This category is present
       inside the database')</script>";
   }else{
...
?> 
<h3 class="text-center">Intsert categories</h3>
<form action="" method="post" class="mb-2">
  <div class="input-group w-90 mb-2">
       ...
       arial-label="Categories" aria-describedby="basic-addon1">  
  </div>
  <div class="input-group w-10 mb-2 m-auto">

     <input type="submit" class="bg-info border-0 p-2 my-0"
     name="insert_cat" value="Insert categories" class="bg-info">  
</div> 
