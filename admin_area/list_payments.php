...
<tbody class='bg-secondary text-light text-center'>";
    ...
    while($row_data=mysqli_fetch_assoc($result)){
        ...
        <td>$date</td>";
        ?>
        <td><a href='index.php?delete_payments=<?php echo $payment_id ?>' type="button"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content"> 
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"><a href='index.php?delete_payments=<?php echo $payment_id ?>' 
