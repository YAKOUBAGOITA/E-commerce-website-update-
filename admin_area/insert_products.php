...
if(isset($_POST['insert_product'])){
     ...
     $product_categories=='' or $product_brands=='' or  
     $product_price=='' or $product_image1=='' or
     $product_image2==''or $product_image3==''){
     echo"<script>alert('please fill all 
     the available fields')</script>";
     exit();}
     else{
          move_uploaded_file($temp_image1,
          "./product_images/$product_image1");
          move_uploaded_file($temp_image2,
          "./product_images/$product_image2");
          move_uploaded_file($temp_image3,
          "./product_images/$product_image3");

          //insert query
          $insert_products="insert into `products`
           (product_title,product_keywords,product_description,
           category_id,brand_id,product_image1,product_image2,product_image3,
           product_price,date,status) values('$product_title'
           ,'$description','$product_keywords','$category_title',
           '$brand_title', $temp_image1, $temp_image2
           , $temp_image3,'$product_price',now(),'$product_status')";
...
<body class="bg-light">
    <div class="container mt-3">
      ...
      <div class="form-outline mb-4 w-50 m-auto">
          <label for="product_title" class="form">Product      
          title</label>
       ...
       <!--description-->
       <div class="form-outline mb-4 w-50 m-auto">
         <label for="description" class="form">Product     
         description</label>
       ...
       <!--keywords-->
       <div class="form-outline mb-4 w-50 m-auto">
         <label for="product_keywords" class="form">Product     
         keywords</label>
       ...
       <!-- image1 -->
       <div class="form-outline mb-4 w-50 m-auto">
       <label for="product_image1" class="form">Product     
       image 1</label>
      ...
      <!-- image2 -->
       <div class="form-outline mb-4 w-50 m-auto">
       <label for="product_image2" class="form">Product   
       image 2</label>
       ...
       <!-- image3 -->
        <div class="form-outline mb-4 w-50 m-auto">
          <label for="product_image3" class="form">Product 
          image3</label>
       ...
       <!-- price-->
        <div class="form-outline mb-4 w-50 m-auto">
           <label for="product_price" class="form">Product     
           price</label>
